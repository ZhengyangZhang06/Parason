...
MODEL_PATH="/storage/openpsi/models/zzy/augment/baseline"
...
python3 -m verl.trainer.main_ppo \
  ...
  trainer.experiment_name="Base-trial-0.025-RL-2" \
  trainer.val_before_train=False \
  trainer.n_gpus_per_node=8 \
  trainer.nnodes=4 \
  trainer.save_freq=5 \
  trainer.test_freq=10 \
  trainer.default_local_dir=/storage/openpsi/users/zzy/checkpoints/deepscaler/Base-trial-0.025-RL-2 \
  trainer.default_hdfs_dir=null \
  trainer.rollout_data_dir=/storage/openpsi/users/zzy/zzy_tw_rollback/Base-trial-0.025-RL-2 \
